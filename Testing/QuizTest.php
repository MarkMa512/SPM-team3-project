...
class QuizTest extends TestCase
{
    public function testConstructGetParams(){
        $quiz = new quiz('Test ID','Title 1', [ ['qnNumber' => 1, 'type' => 'mcq', 'qnText' => 'Q1', 'options' => [['id' => 'q1-1', 'optText' => 'A1', 'value' => 1], ['id' => 'q1-2', 'optText' => 'A2', 'value' => 2], ['id' => 'q1-3', 'optText' => 'A3', 'value' => 3]]],
        ...
        $this -> assertEquals('Test ID', $quiz->getQuizID());                            
